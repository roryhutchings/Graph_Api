...
const LocationType = new GraphQLObjectType({
  ...
  fields: () => ({
    ...
    reviews: {
      //queries main database with commonuser to get all review information, gets passed a locationid in graphqlID format
      type: new GraphQLList(reviewtypes.ReviewType),
      resolve(parent, args) {
        return new queries.Reviews(
          pools.mainpoolcommonquery
        ).getReviewsByLocation(parent.locationid);
      },
    },
  }),
});
